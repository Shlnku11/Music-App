# Generated by Django 6.0.3 on 2026-06-19 13:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('youtube', 'YouTube Music'), ('itunes', 'iTunes')], default='youtube', max_length=20)),
        ...
        migrations.AddField(
            model_name='music',
            name='type_music',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='musics', to='main.typemusic'),
        ),
        migrations.CreateModel(
            name='Favorite',
            fields=[
